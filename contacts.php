		...
		<div class="wrapper main-wrapper">
			<div id="sidebar">
				<div class="sr-container">
					<h2>Helpful informations</h2>
					<ul>
						<a href="#"><li>Why i need to register?</li></a>
						<a href="#"><li></li></a>
						<a href="#"><li></li></a>
					...
					<div class="content-page-form">
						<form method="post">
							<div class="form-group">
								<label title for="email">Your email</label>
								<div class="controls">
							...
							<div class="form-group">
								<label title for="email">Name</label>
								<div class="controls">
									<input type="text" autocomplete="off" autocorrect="off" autocapitalize="off">
								</div>
							</div>
							<div class="form-group">
								<label title for="email">Message</label>
								<div class="controls">
									<textarea type="text" autocomplete="off" autocorrect="off" autocopitalize="off"></textarea>
								</div>
							</div>
